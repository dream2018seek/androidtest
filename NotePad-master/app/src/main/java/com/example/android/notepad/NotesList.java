 ...
 */
public class NotesList extends Activity implements AdapterView.OnItemClickListener{
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(keyword.isEmpty())
                {
                    ...
                    loadData(NotePad.Notes.COLUMN_NAME_TITLE+" like ?",new String[]{"%"+keyword+"%"});
    ...
    private void loadData(String selection,String[] selectionArgs)
    {
        data.clear();
        ...
        if(mCursor != null && mCursor.getCount() >0)
        {
            while(mCursor.moveToNext())
            {
                ...
                bean.setId(mCursor.getInt(mCursor.getColumnIndex(NotePad.Notes._ID)));
                bean.setTitle(mCursor.getString(mCursor.getColumnIndex(NotePad.Notes.COLUMN_NAME_TITLE)));
                bean.setDate(mCursor.getLong(mCursor.getColumnIndex(NotePad.Notes.COLUMN_NAME_CREATE_DATE)));
                data.add(bean);
            }
        }
    }
    ...
    class MyAdapter extends BaseAdapter
    {
        ...
        public  MyAdapter(Context context,List<NoteBean> data)
        {
            this.data =data;
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            NoteBean bean = (NoteBean) getItem(i);
            if(view == null)
            {
                view = inflater.inflate(R.layout.noteslist_item,null);
...
//END_INCLUDE(copy)
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        Uri uri = ContentUris.withAppendedId(getIntent().getData(), data.get(i).getId());
